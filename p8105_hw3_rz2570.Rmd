...
ggplot(accel_longer, aes(x = day_id, y = total_activity)) +
  geom_point() +
  geom_line()
```

* There are no apparent trends of total activity against the days. However, we might tell from the wavy line that each "active" day are followed with one or more "inactive" days.
